...
CarsPanel::CarsPanel(QWidget* parent) : QWidget(parent) {
    ...
    commonToggles->addItem(new CValueControl("Model", "Select your preferred openpilot model.", "0:North Dakoda(Default),1:=Notre Dame,2:SGO=SGO", "../assets/offroad/icon_calibration.png", 0, 2, 1));
