...
void DevicePanel::updateCalibDescription() {
  QString desc =
      tr("openpilot requires the device to be mounted within 4째 left or right and "
         "within 5째 up or 9째 down. openpilot is continuously calibrating, resetting is rarely required.");
