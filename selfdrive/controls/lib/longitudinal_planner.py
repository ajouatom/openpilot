...
class LongitudinalPlanner:
  ...
  def update(self, sm, carrot_planner):
    ...
    self.mpc.update(sm, reset_state, prev_accel_constraint, self.lead_one, self.lead_two, v_cruise, x, v, a, j, carrot_planner, personality=sm['controlsState'].personality)
