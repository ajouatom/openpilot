...
window.CarrotTranslations.register("fr", {
  ...
  strings: {
    ...
    default_value_confirm: "Restaurer {name} à la valeur par défaut ({value}) ?",
    ...
    setting_profile_create_title: "Ajouter profil",
    setting_profile_create_prompt: "Saisissez un nom de profil.",
    setting_profile_name: "Nom du profil",
    setting_profile_created: "Créé",
    setting_profile_value: "Profil",
    setting_profile_apply_title: "Appliquer profil",
    setting_profile_apply_done: "Profil appliqué",
    setting_profile_apply_failed: "Échec d'application du profil",
    setting_profile_delete: "Supprimer profil",
    setting_profile_delete_confirm: "Supprimer ce profil ?\n{name}",
    setting_profile_saved: "Profil enregistré",
    setting_profile_deleted: "Profil supprimé",
    setting_profile_save_failed: "Échec d'enregistrement du profil",
    ...
    settings_diff_changed: "Modifié",
    settings_diff_same: "Identique",
    settings_diff_skipped: "Ignoré",
    settings_diff_invalid: "Invalide",
    settings_diff_current: "Actuel",
    settings_diff_apply: "Appliquer",
    settings_diff_changed_status: "Modifié",
    settings_diff_no_changes: "Aucun changement à appliquer.",
    settings_diff_more: "{count} changements masqués",
