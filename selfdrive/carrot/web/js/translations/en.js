...
window.CarrotTranslations.register("en", {
  ...
  strings: {
    ...
    youtube_live_check_error_section: "Errors and FFmpeg logs",
    ...
    youtube_live_error_input_invalid: "Could not open the video input because an FFmpeg argument was invalid.",
    youtube_live_error_ffmpeg_missing: "FFmpeg is not installed.",
    youtube_live_error_no_frames: "No qRoadEncodeData frames were received.",
    youtube_live_error_ffmpeg_exit: "FFmpeg exited (code {code}).",
    youtube_live_error_ffmpeg_pipe: "The FFmpeg input pipe was closed.",
    youtube_live_error_muxer_missing: "PyAV MPEG-TS muxing is unavailable.",
    youtube_live_error_muxer_failed: "MPEG-TS muxing failed: {error}",
    youtube_live_test: "Test",
    youtube_live_test_missing: "Missing stream key or FFmpeg.",
    youtube_live_test_muxer_missing: "Stream key, FFmpeg, or PyAV MPEG-TS support is missing.",
    ...
    youtube_live_state_starting: "Starting FFmpeg",
    youtube_live_state_live: "Streaming to YouTube RTMPS",
    youtube_live_state_stopping: "Stopping FFmpeg",
