...
window.CarrotTranslations.register("en", {
  ...
  strings: {
    ...
    setting_reset_defaults_done: "Settings reset signal sent. The device may restart to apply it.",
    setting_reset_defaults_failed: "Failed to request settings reset",
