...
window.CarrotTranslations.register("zh", {
  ...
  strings: {
    ...
    youtube_live_check_error_section: "错误和 FFmpeg 日志",
    ...
    youtube_live_error_input_invalid: "FFmpeg 参数无效，无法打开视频输入。",
    youtube_live_error_ffmpeg_missing: "未安装 FFmpeg。",
    youtube_live_error_no_frames: "未收到 qRoadEncodeData 帧。",
    youtube_live_error_ffmpeg_exit: "FFmpeg 已退出（代码 {code}）。",
    youtube_live_error_ffmpeg_pipe: "FFmpeg 输入管道已关闭。",
    youtube_live_error_muxer_missing: "无法使用 PyAV MPEG-TS 封装。",
    youtube_live_error_muxer_failed: "MPEG-TS 封装失败：{error}",
    youtube_live_test: "Test",
    youtube_live_test_missing: "Missing stream key or FFmpeg.",
    youtube_live_test_muxer_missing: "缺少串流密钥、FFmpeg 或 PyAV MPEG-TS 支持。",
    ...
    youtube_live_state_starting: "正在启动 FFmpeg",
    youtube_live_state_live: "正在推流到 YouTube RTMPS",
    youtube_live_state_stopping: "正在停止 FFmpeg",
