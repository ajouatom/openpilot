...
window.CarrotTranslations.register("ja", {
  ...
  strings: {
    ...
    delete: "削除",
    default_value: "デフォルト",
    default_value_confirm: "{name} をデフォルト値 ({value}) に戻しますか？",
    ...
    setting_profiles: "プロファイル",
    setting_profile_create_title: "プロファイル追加",
    setting_profile_create_prompt: "プロファイル名を入力してください。",
    setting_profile_name: "プロファイル名",
    setting_profile_created: "作成日時",
    setting_profile_value: "プロファイル",
    setting_profile_apply_title: "プロファイル適用",
    setting_profile_apply_done: "プロファイルを適用しました",
    setting_profile_apply_failed: "プロファイルの適用に失敗しました",
    setting_profile_delete: "プロファイル削除",
    setting_profile_delete_confirm: "このプロファイルを削除しますか？\n{name}",
    setting_profile_saved: "プロファイルを保存しました",
    setting_profile_deleted: "プロファイルを削除しました",
    setting_profile_save_failed: "プロファイルの保存に失敗しました",
    ...
    settings_diff_changed: "変更",
    settings_diff_same: "同じ",
    settings_diff_skipped: "スキップ",
    settings_diff_invalid: "無効",
    settings_diff_current: "現在",
    settings_diff_apply: "適用",
    settings_diff_changed_status: "変更",
    settings_diff_no_changes: "適用する変更はありません。",
    settings_diff_more: "ほか {count} 件の変更を非表示",
    logs_dashcam: "ドライブ録画",
