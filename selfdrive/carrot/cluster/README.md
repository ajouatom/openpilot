...
LR/RR distance when the current cereal schema exposes it, plus blindspot
booleans; without exact rear fields, the HUD can still show coarse LR/RR
blindspot fallback vehicle boxes.
