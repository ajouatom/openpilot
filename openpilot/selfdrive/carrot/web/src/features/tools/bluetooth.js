const WORDS = {
  ko: {
    ...
    grabbed: "HID 입력 독점 중", inactive: "입력 독점 대기 (연결·매핑 사용 여부 확인)", learnHelp: "먼저 입력 종류와 매핑을 저장한 뒤 시험을 시작하세요. 일반 HID는 시험 중 버튼을 한 번 눌렀다 떼어 등록합니다. 변경한 기능은 다시 저장해야 적용됩니다. 길게 눌러도 반복 가속하지 않습니다.",
  ...
  en: {
    ...
    learnHelp: "Save the input profile and mapping before testing. For generic HID devices, press and release each button during the test to learn it. Save again to apply edited actions. Holding a key does not repeat acceleration.",
