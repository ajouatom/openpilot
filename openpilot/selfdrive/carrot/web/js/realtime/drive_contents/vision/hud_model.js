...
globalThis.DriveVisionHudModel = (() => {
  ...
  function formatDebugText(overlayState, customSteerRatio) {
    ...
    const customSr = finiteNumber(customSteerRatio, 0) / 10.0;
