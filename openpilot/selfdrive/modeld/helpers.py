...
def usbgpu_present() -> bool:
  # The custom bridge can fall back to USB 2.0 enumeration when its
  # SuperSpeed link is down. It still exposes the same VID/PID in that state,
  # but PCIe power-up and model loading cannot succeed over the 480 Mbps link.
