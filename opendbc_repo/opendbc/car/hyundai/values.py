...
class HyundaiExtFlags(IntFlag):
  ...
  CANFD_GEARS_69 = 2 ** 10
  CORNER_RADAR_OBJECTS_235 = 2 ** 11  # 0x230 status + 0x235-0x248 raw corner radar objects
  CORNER_RADAR_OBJECTS_180 = 2 ** 12  # 0x180-0x184 bus 1 two-slot raw corner/front radar objects
