...
def create_acc_control_scc2(packer, CAN, enabled, accel_last, accel, stopping, gas_override, set_speed, hud_control, jerk_u, jerk_l, CS, a_target_now):
  ...
  if CS.out.carrotCruise > 0 and not gas_override:
